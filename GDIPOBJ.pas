...
//--------------------------------------------------------------------------
  ...
  public
    ...
    function GetFamilyName(out name: ansistring; language: LANGID = 0): TStatus;
...
\**************************************************************************)
  ...
  public
    ...
    function SetMeasurableCharacterRanges(rangeCount: Integer; ranges: PAnsiCharacterRange): TStatus;
...
\**************************************************************************)
  ...
  function TGPStringFormat.SetMeasurableCharacterRanges(rangeCount: Integer;
    ranges: PAnsiCharacterRange): TStatus;
  begin
...
\**************************************************************************)
  ...
  function TGPFontFamily.GetFamilyName(out name: ansistring; language: LANGID = 0): TStatus;
