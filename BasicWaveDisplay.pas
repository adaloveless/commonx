...
procedure TFrameBasicWaveDisplay.Debug(sMessage: ansistring);
begin
  lblDebug.caption := sMessage;
end;

procedure TFrameBasicWaveDisplay.Dele1Click(Sender: TObject);
begin
  ParamChannels[EditingChannel][EditingAxis].remove(FACtiveCurve);
  DirtyWave := true;
end;

procedure TFrameBasicWaveDisplay.DeleteMarker(idx: integer);
begin
  FMarkers[idx].free;
  FMarkers.delete(idx);
  SaveMarkers;
...
destructor TFrameBasicWaveDisplay.Destroy;
begin
...
procedure TFrameBasicWaveDisplay.DirtyDisplay;
begin
  ValidateMarkerIndex;
  DirtyWave := true;
  notifyDataChange;
...
function TFrameBasicWaveDisplay.GetDataLength: int64;
begin
...
function TFrameBasicWaveDisplay.GetEventColor(iType: integer): TColor;
var
...
function TFrameBasicWaveDisplay.GetEvents(idx: integer): TSoundMarker;
begin
  result := FEvents[idx];
end;

function TFrameBasicWaveDisplay.GetFSamples(idx: int64): smallint;
var
...
function TFrameBasicWaveDisplay.GetIsPlaying: boolean;
begin
...
function TFrameBasicWaveDisplay.GetMarkerCount: integer;
begin
  result := FMarkers.count;
end;

function TFrameBasicWaveDisplay.GetMarkers(idx: integer): TSoundMarker;
begin
  result := FMarkers[idx];
end;

function TFrameBasicWaveDisplay.GetMonoMergedIntegerSamples(idx: int64): integer;
begin
  if FChannels > 1 then
  begin
...
function TFrameBasicWaveDisplay.GetSampleEx(idx: int64; iChannel: integer): nativefloat;
begin
  if FChannels > 1 then
  begin
    idx := idx * FChannels;
...
function TFrameBasicWaveDisplay.GetMonoMergedSamples(idx: int64): nativefloat;
begin
  if idx < 0 then idx := 0;
...
function TFrameBasicWaveDisplay.GEtParamChannels(idx: integer): TParamChannel;
var
  pc: TParamChannel;
begin
...
function TFrameBasicWaveDisplay.GetSampleLength: int64;
begin
  result := FStream.SampleCount;
//  result := (GetDataLength) div (2 * FChannels);
end;

function TFrameBasicWaveDisplay.GetSampleOnDisplay(x: nativefloat): integer;
begin
...
function TFrameBasicWaveDisplay.GetSampleSummary(iStart, iEnd: int64;
...
function TFrameBasicWaveDisplay.GetAmplitudeFromScreen(y: nativefloat): nativefloat;
begin
  result := (((VIEW_HEIGHT - 1) - y) / (VIEW_HEIGHT- 1));
end;

function TFrameBasicWaveDisplay.GetScreenPositionForSample(x: integer): integer;
var
  r: nativefloat;
  s, e: nativefloat;
begin
...
procedure TFrameBasicWaveDisplay.ValidateMarkerIndex;
begin
...
function TFrameBasicWaveDisplay.GetSelectedMarker: TSoundMarker;
begin
   ValidateMarkerIndex;
...
procedure TFrameBasicWaveDisplay.MarkClick(Sender: TObject);
begin
...
procedure TFrameBasicWaveDisplay.MarkerChanged;
begin
  DirtyWave := true;
...
procedure TFrameBasicWaveDisplay.HookMouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; x, y: integer);
begin
...
function TFrameBasicWaveDisplay.GetPointToPlot(x, y: integer; out ox: int64;
...
procedure TFrameBasicWaveDisplay.GetKnobWindow(x, y: integer; out xStart, xEnd: int64;
  out yStart, yEnd: nativefloat);
begin
...
procedure TFrameBasicWaveDisplay.MouseDownForCurve(Sender: TObject;
...
function TFrameBasicWaveDisplay.GetCurveKnobPosition(rAmp: nativefloat): integer;
begin
  if IsNAN(rAmp) then
    rAmp := 0.0;
...
procedure TFrameBasicWaveDisplay.MouseDownForWave
...
procedure TFrameBasicWaveDisplay.NameAxis(iChannel, iAxis: nativeint; sName: string);
begin
  FCurveNames[iChannel][iAxis] := sName;
  UpdateNames;
end;

procedure TFrameBasicWaveDisplay.UpdateNames;
var
  t,u: integer;
  s: string;
begin
...
procedure TFrameBasicWaveDisplay.HookMouseMove(Sender: TObject; Shift: TShiftState;
  x, y: integer);
var
  t: integer;
  cvTemp: TCurve;
...
procedure TFrameBasicWaveDisplay.HookMouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; x, y: integer);
begin
...
procedure TFrameBasicWaveDisplay.NotifyDatachange;
begin
...
procedure TFrameBasicWaveDisplay.DrawWave;
var
  t: integer;
  r: nativefloat;
  amp: nativefloat;
...
procedure TFrameBasicWaveDisplay.FrameResize(Sender: TObject);
begin
//  pbWave.Dirty := true;
  Dirtydisplay;
end;

procedure TFrameBasicWaveDisplay.FreeAndClearParamChannels;
var
  t: integer;
begin
...
procedure TFrameBasicWaveDisplay.Play(iFrom: int64; iTo: int64);
begin
  ValidateSelection;
  if iFrom > -1 then
  begin
...
function TFrameBasicWaveDisplay.Playing: boolean;
begin
  result := IsPlaying;
end;

procedure TFrameBasicWaveDisplay.REfreshScrollbar;
var
  b: boolean;
begin
...
procedure TFrameBasicWaveDisplay.Resize;
begin
  inherited;
  DrawWave;
end;

procedure TFrameBasicWaveDisplay.ScrollBarChange(Sender: TObject);
var
  ps: int64;
begin
...
procedure TFrameBasicWaveDisplay.SetActiveCurve(const Value: TCurve);
begin
  FActiveCurve := Value;
  dirtydisplay;
end;

procedure TFrameBasicWaveDisplay.SetAlphaBackGroundcolor(const Value: TColor);
begin
  FAlphaBackGroundColor := Value;
  DirtyDisplay;
end;

procedure TFrameBasicWaveDisplay.SetCurveMask(const Value: integer);
begin
  FCurveMask := Value;
  pbWave.dirty := true;
end;
...
procedure TFrameBasicWaveDisplay.SetDeviceIndex(const Value: nativeint);
begin
  FDeviceIndex := Value;
  self.ChangedDeviceID(value);
end;

procedure TFrameBasicWaveDisplay.SetDirtyWave(const Value: boolean);
begin
  FDirtyWave := Value;
  pbWave.Dirty := true;
end;

procedure TFrameBasicWaveDisplay.SetDrawMode(const Value: TDrawMode);
begin
  FDrawMode := Value;
  DirtyDisplay;
end;

procedure TFrameBasicWaveDisplay.SetEditingAxis(const Value: integer);
begin
  FEditingAxis := Value;
  DirtyDisplay;
  MarkMode := false;
...
procedure TFrameBasicWaveDisplay.SetEditingChannel(const Value: integer);
begin
...
procedure TFrameBasicWaveDisplay.SetSelectedMarker(const Value: TSoundMarker);
begin
  FSelectedMarkerIndex := FMarkers.IndexOf(Value);
end;

procedure TFrameBasicWaveDisplay.SetSelectedMarkerIndex(const Value: integer);
begin
  FSelectedMarkerIndex := Value;
end;

procedure TFrameBasicWaveDisplay.SetSelectEnd(const Value: int64);
begin
  FSelectEnd := Value;
...
procedure TFrameBasicWaveDisplay.SetState(const Value: TSoundGUISTate);
begin
  Fstate := Value;
  case Fstate of
    ssZoomIn:
...
procedure TFrameBasicWaveDisplay.SetTempo(const Value: nativefloat);
begin
  FTempo := Value;
  dirtyDisplay;
end;

procedure TFrameBasicWaveDisplay.SetViewEnd(Value: int64);
begin
...
procedure TFrameBasicWaveDisplay.SetViewStart(Value: int64);
begin
  if Value < 0 then
    Value := 0;
...
procedure TFrameBasicWaveDisplay.SetWaveAlpha(const Value: nativefloat);
begin
  FWaveAlpha := Value;
  DirtyDisplay;
end;

function TFrameBasicWaveDisplay.SortCurve: boolean;
...
procedure TFrameBasicWaveDisplay.StopPlaying;
begin
...
procedure TFrameBasicWaveDisplay.DrawCurveAxies(iCh, iStart, iThru: integer);
var
  t: integer;
  cv, cv1, cv2: TCurve;
  bHead, bTail: boolean;
...
procedure TFrameBasicWaveDisplay.DrawCurves;
var
  t: integer;
  cv, cv1, cv2: TCurve;
  bHead, bTail: boolean;
...
procedure TFrameBasicWaveDisplay.DrawCurveMarkers;
var
  t: integer;
  sm: TSoundMarker;
  bHead, bTail: boolean;
...
procedure TFrameBasicWaveDisplay.DrawEvents;
var
  t: integer;
  sm: TSoundMarker;
  bHead, bTail: boolean;
...
procedure TFrameBasicWaveDisplay.DrawKnob(xScreen, yScreen: integer; c: TColor; bBackground: boolean = false);
var
  t,u: integer;
  r: TRect;
  rAlpha: nativefloat;
...
procedure TFrameBasicWaveDisplay.DrawKnobLine(x1Screen, y1Screen, x2Screen,
...
procedure TFrameBasicWaveDisplay.DrawTimer(Sender: TObject);
begin
  if assigned(FPlayCommand) then
  begin
    if (FPlayCommand.running) then
...
procedure TFrameBasicWaveDisplay.ValidateSelection;
var
  iTemp: int64;
begin
...
procedure TFrameBasicWaveDisplay.ValidateView;
var
  iTemp: int64;
begin
...
function TFrameBasicWaveDisplay.VIEW_HEIGHT: integer;
begin
  result := height;

end;

function TFrameBasicWaveDisplay.VIEW_WIDTH: integer;
begin
  result := width;

end;

procedure TFrameBasicWaveDisplay.ZoomInClick(Sender: TObject);
begin
...
procedure TFrameBasicWaveDisplay.ZoomKeepLevel(iPOint: integer);
var
  iStart: integer;
  iEnd: integer;
  w: integer;
...
procedure TFrameBasicWaveDisplay.ZoomMakeShowing(iPoint1, iPOint2: int64);
var
  iStart: int64;
  iEnd: int64;
begin
...
procedure TFrameBasicWaveDisplay.ZoomOutClick(Sender: TObject);
var
  viewwidth: int64;
  viewcenter: int64;
begin
...
procedure TFrameBasicWaveDisplay.ZoomTo(iStart, iEnd: int64;
...
procedure TFrameBasicWaveDisplay.PanelPaint;
begin
  inherited;
  DrawWave;
end;

procedure TFrameBasicWaveDisplay.pbWaveDblClick(Sender: TObject);
var
  t: integer;
  xStart, xEnd: int64;
...
procedure TFrameBasicWaveDisplay.pbWavePaint(Sender: TObject);
begin
  try
    DrawWave;
  except
...
procedure TFrameBasicWaveDisplay.SetNoPaint(const Value: boolean);
begin
...
procedure TFrameBasicWaveDisplay.SetLastMouseDown(x, y: integer);
begin
  FLastMouseDownX := x;
  FLastMouseDownY := y;
end;

procedure TFrameBasicWaveDisplay.SetLoopEnd(const Value: int64);
begin
  FLoopend := Value;
  DrawWave;
end;

procedure TFrameBasicWaveDisplay.SetLoopStart(const Value: int64);
begin
  FLoopStart := Value;
  DrawWave;
end;

procedure TFrameBasicWaveDisplay.SetMarkMode(const Value: boolean);
begin
  FMarkMode := Value;
  DirtyDisplay;
end;

procedure TFrameBasicWaveDisplay.SetSampleEnd(const Value: int64);
begin
  FSampleend := Value;
  DrawWave;
end;

procedure TFrameBasicWaveDisplay.SetSampleStart(const Value: int64);
begin
  FSampleStart := Value;
  DrawWave;
end;

procedure TFrameBasicWaveDisplay.UnMarkClick(Sender: TObject);
begin
  UnMark;
end;

procedure TFrameBasicWaveDisplay.TweakInLeftClick(Sender: TObject);
begin
  SampleStart := self.SearchForZeroCrossing(SampleStart, true, false);
end;

procedure TFrameBasicWaveDisplay.TweakInLoopLeftClick(Sender: TObject);
begin
  LoopStart := self.SearchForZeroCrossing(LoopStart, true, false);
end;

procedure TFrameBasicWaveDisplay.TweakInLoopRightClick(Sender: TObject);
begin
  LoopStart := self.SearchForZeroCrossing(LoopStart, false, true);
end;

procedure TFrameBasicWaveDisplay.TweakInRightClick(Sender: TObject);
begin
  SampleStart := self.SearchForZeroCrossing(SampleStart, false, true);
end;

function TFrameBasicWaveDisplay.SearchForZeroCrossing
...
procedure TFrameBasicWaveDisplay.UnMark;
begin
  // SelectStart := -1;
  SampleStart := -1;
  LoopStart := -1;
...
procedure TFrameBasicWaveDisplay.TweakOutLeftClick(Sender: TObject);
begin
  SampleEnd := self.SearchForZeroCrossing(SampleEnd, true, false);
end;

procedure TFrameBasicWaveDisplay.TweakOutLoopLeftClick(Sender: TObject);
begin
  LoopEnd := self.SearchForZeroCrossing(LoopEnd, true, false);
end;

procedure TFrameBasicWaveDisplay.TweakOutLoopRightClick(Sender: TObject);
begin
  LoopEnd := self.SearchForZeroCrossing(LoopEnd, false, true);
end;

procedure TFrameBasicWaveDisplay.TweakOutRightClick(Sender: TObject);
begin
  SampleEnd := self.SearchForZeroCrossing(SampleEnd, false, true);
end;

procedure TFrameBasicWaveDisplay.UnSelectClick(Sender: TObject);
begin
  SelectStart := -1;
  DrawWave;
end;

procedure TFrameBasicWaveDisplay.SetSelectStart(const Value: int64);
begin
  FSelectStart := Value;
  DrawWave;
end;

procedure TFrameBasicWaveDisplay.PlayScrub(iStart, iLength: integer);
begin
...
procedure TFrameBasicWaveDisplay.PlaySelectedMarker;
begin
  if SelectedMarker = nil then
    exit;
...
procedure TFrameBasicWaveDisplay.PlaySelection;
begin
  Play(SelectStart, SelectEnd);
end;

procedure TFrameBasicWaveDisplay.popWavePopup(Sender: TObject);
begin
  Dele1.Enabled := FACtiveCurve <> nil;
end;

procedure TFrameBasicWaveDisplay.PlayLoop(iRepeats: integer);
var
...
function TFrameBasicWaveDisplay.GetStream: TSoundSTream;
begin
  result := FStream;
end;

function TFrameBasicWaveDisplay.IndexOfMarker(sm: TSoundMarker): integer;
begin
  result := FMarkers.IndexOf(sm);
end;

function TFrameBasicWaveDisplay.IndexOfParamChannel(iConstant: integer): integer;
var
  t: integer;
begin
  result := -1;
...
procedure TFrameBasicWaveDisplay.InitParamChannels;
begin
  FParamChannels := TList<TParamChannel>.Create;
end;

function TFrameBasicWaveDisplay.IsInMarker(x: int64): boolean;
var
  t: integer;
  m: TSoundMarker;
begin
...
procedure TFrameBasicWaveDisplay.LoadCurves;
var
  t: integer;
begin
...
procedure TFrameBasicWaveDisplay.LoadEvents(sFile: string);
var
  sl: TStringlist;
  sm: TSoundMarker;
  t: integer;
...
procedure TFrameBasicWaveDisplay.LoadFromFile(sAdaOrMp3File: ansistring; sMetaFile: string = '');
begin
  if sMetaFile = '' then
...
procedure TFrameBasicWaveDisplay.LoadMarkers();
var
  sl: TStringlist;
  sm: TSoundMarker;
  t: integer;
...
procedure TFrameBasicWaveDisplay.LoadMetaData;
begin
  LoadMarkers;
  LoadCurves;
...
function TFrameBasicWaveDisplay.SampleToBeat(iSample: int64): nativefloat;
begin
  if Tempo = 0 then
    result := 0
  else
...
procedure TFrameBasicWaveDisplay.SaveCurves;
var
  t: integer;
begin
  for t := 0 to FParamChannels.count - 1 do
...
procedure TFrameBasicWaveDisplay.SaveLoop(sBoogerFile: ansistring);
begin
...
procedure TFrameBasicWaveDisplay.SaveMarkers();
begin
  FMarkers.SaveToFile(changefileext(LoadedMetaFrom, '.mark'));
end;

procedure TFrameBasicWaveDisplay.SaveMetaData;
begin
  SaveMarkers;
  SaveCurves;
end;

procedure TFrameBasicWaveDisplay.SaveToFile(sBoogerFile: ansistring);
begin
...
procedure TFrameBasicWaveDisplay.ToneGate(iOutputChannel, iPitchChannel,
...
procedure TFrameBasicWaveDisplay.TransientDetection(iOutputChannel, iPitchChannel,
...
procedure TFrameBasicWaveDisplay.TransientDetectionFromSpectrum(iOutputChannel,
