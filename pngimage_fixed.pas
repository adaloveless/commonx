...
(*  TMAXBITMAPINFO = packed record
  ...
  private
    ...
    procedure DrawPartialTransOld(DC: HDC; Rect: TRect);
  protected
    {Being created}
  ...
  public
    ...
    function GetGPBitmap: TGPBitmap;
  end;
...
//  inherited;
  ...
  graphics := nil;
  gpib := nil;
  graphics := GDIPOBJ.TGPGraphics.Create(DC);
  try
    png := self;
    bi := png.Header.BitmapInfo;
    ...
    //    img.Picture.Graphic.SaveToStream(s);
    ...
    rr.x := 0;
    rr.y := 0;
    rr.Width := rect.Right - rect.left;
    rr.Height := rect.Bottom - rect.Top;

    graphics.DrawImage(gpib, rr);
//    graphics.DrawImage(gpib, pt);
...
procedure TPngObject.DrawPartialTransOld(DC: HDC; Rect: TRect);
...
function TPngObject.GetGPBitmap: TGPBitmap;
var
  rr: TGPRect;
  pt: TGPPointF;
  bi: tagBitMapInfo;
