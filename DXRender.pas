...
var
  CPUIDVendor: array[0..11] of AnsiChar;
        ...
        begin
          ...
          begin
            ...
            @@EndCode:
              ...
              { Delphi 6 Fix By: BanDiT & Ronny }
              xor eax, eax
              mov eax, Dest
              push ebx
              xor ebx, ebx
              mov bx,TDXRMachine_Color.R
              add eax, ebx
              inc eax
              pop ebx
              { End Delphi 6 Fix }
    ...
    begin
      ...
      begin
        ...
        @@EndCode:
          ...
          { Delphi 6 Fix By: BanDiT & Ronny Begin }
          mov eax, Src;
          xor ebx, ebx;
          mov bx,TDXRMachine_Color.G;
          add eax, ebx;
  ...
  procedure genBlend(var Code: Pointer; Blend: TDXR_Blend;
    ...
    begin
      ...
      @@StartCode:
        ...
        { D6 Fix By: BanDiT & Ronny }
        push ebx
        mov ebx, eax
        add ebx, edx
        add ebx, offset _AddTable
        mov al, byte ptr [ebx]
        pop ebx
        {End Fix}
        mov byte ptr [offset _null],al{}@@Dest:
