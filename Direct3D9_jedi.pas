...
{$ENDIF}
  ...
  IDirect3D9 = interface(IUnknown)
    ...
    function CreateDevice(Adapter: LongWord; DeviceType: TD3DDevType; hFocusWindow: DXHWND; BehaviorFlags: DWord; pPresentationParameters: PD3DPresentParameters; out ppReturnedDeviceInterface: IDirect3DDevice9): HResult; stdcall;
  end;
...
{$IFDEF DIRECT3D_VERSION_9_VISTA}
  ...
  IDirect3D9Ex = interface(IDirect3D9)
    ...
    function CreateDeviceEx(Adapter: LongWord; DeviceType: TD3DDevType; hFocusWindow: DXHWND; BehaviorFlags: DWORD; pPresentationParameters: PD3DPresentParameters; pFullscreenDisplayMode: PD3DDisplayModeEx; out ppReturnedDeviceInterface: IDirect3DDevice9Ex): HResult; stdcall;
...
{ SwapChain }
  ...
  IDirect3DDevice9 = interface(IUnknown)
    ...
    function Present(pSourceRect, pDestRect: PRect; hDestWindowOverride: DXHWND; pDirtyRegion: PRgnData): HResult; stdcall;
...
{$IFDEF DIRECT3D_VERSION_9_VISTA}
  ...
  IDirect3DDevice9Ex = interface(IDirect3DDevice9)
    ...
    function PresentEx(const pSourceRect, pDestRect: PRect; hDestWindowOverride: DXHWND; const pDirtyRegion: PRgnData; dwFlags: DWORD): HResult; stdcall;
    ...
    function CheckDeviceState(hDestinationWindow: DXHWND): HResult; stdcall;
...
{$ENDIF}
  ...
  IDirect3DSwapChain9 = interface(IUnknown)
    ...
    function Present(pSourceRect, pDestRect: PRect; hDestWindowOverride: DXHWND; pDirtyRegion: PRgnData; dwFlags: DWORD): HResult; stdcall;
...
function _Direct3DCreate9(SDKVersion: LongWord): Pointer; external Direct3D9dll delayed name 'Direct3DCreate9';
{$IFDEF DIRECT3D_VERSION_9_VISTA}
