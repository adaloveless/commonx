...
type
  ...
  protected
    ...
    procedure DoUDPReadOuter(AThread: TIdUDPListenerThread; const AData: TIdBytes; ABinding: TIdSocketHandle); virtual;
...
procedure TIdUDPServer.DoUDPReadOuter(AThread: TIdUDPListenerThread;
  const AData: TIdBytes; ABinding: TIdSocketHandle);
begin
  DoUDPRead(Athread, Adata, ABinding);
end;
...
function TIdUDPListenerThread.HandleRunException(
...
begin
  FServer.DoUDPReadOuter(Self, FBuffer, FBinding);
end;
