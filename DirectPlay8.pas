 ...
 ****************************************************************************)
  ...
  IDirectPlay8AddressIP = interface(IUnknown)
    ...
    // Constructs a TCP Address from a ansistring (hostname) and port
 ...
 ****************************************************************************)
  ...
  _DPNMSG_NAT_RESOLVER_QUERY = packed record
    ...
    pwszUserString: PWideChar;	// User specified ansistring, or NULL if none
  end;
 ...
 ****************************************************************************)
  ...
  DVCOMPRESSIONINFO = packed record
    ...
    lpszName: PWideChar;           // ansistring name of this compression type
