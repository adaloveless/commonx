...
uses Variants, variantlist, classes, sysutils, requestinfo, dialogs, MTDTInterface, WebDispatch, windows, Exceptions, ErrorResource,systemx, Dataobject, webfunctions, sharedobject, simplewinsock, debug, stringx, typex;
