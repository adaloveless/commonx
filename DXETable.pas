...
function DDrawErrorMsg(ErrorCode: HRESULT): ansistring;
function D3DErrorMsg(ErrorCode: HRESULT): ansistring;
function D3DRMErrorMsg(ErrorCode: HRESULT): ansistring;
function DSoundErrorMsg(ErrorCode: HRESULT): ansistring;
function DInputErrorMsg(ErrorCode: HRESULT): ansistring;
function DPlayErrorMsg(ErrorCode: HRESULT): ansistring;
