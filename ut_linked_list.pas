...
type
  ...
  TUT_LinkedList = class(TUnitTest)
  private
    type TDebuggable = class(TBetterObject)
          public
            function GetDebug: string;
          end;
    type TObjA = class(TBetterObject);
    type TObjB = class(TBetterObject);
    type TObjC = class(TBetterObject);
    type TObjD = class(TBetterObject);
    type TObjE = class(TBetterObject);
  public
    ll: TDirectlyLInkedList_Shared<TBetterObject>;
    ll2: TDirectlyLInkedList_Shared<TBetterObject>;
...
procedure TUT_LinkedList.BeforeDestruction;
begin
  inherited;
  ll.free;
  ll := nil;
...
function TUT_LinkedList.DebugContents: string;
var
  t: ni;
begin
  result := '';
  for t := 0 to ll.count-1 do begin
    result := result + '['+TDebuggable(ll.items[t]).GetDebug+']'
  end;
  result := result + ' count:'+ll.Count.tostring+' slowcount:'+ll.slowcount.tostring;



end;

procedure TUT_LinkedList.DoExecute;
var
  bo: TBetterObject;
  tmp: TObjA;
begin
  ...
  case variation of
    10: begin
      VariationName := 'Add ObjA';
      ll.Add(TObjA.create);
      utresult := DebugContents;
    end;
    20: begin
      VariationName := 'Add ObjB';
      ll.Add(TObjA.create);
      ll.Add(TObjB.create);
      utresult := DebugContents;
    end;
    30: begin
      VariationName := 'Add ObjC First';
      ll.Add(TObjA.create);
      ll.Add(TObjB.create);
      ll.AddFirst(TObjC.create);
      utresult := DebugContents;
    end;
    40: begin
      VariationName := 'REmove ObjA';
      ll.Add(TObjA.create);
      ll.Add(TObjB.create);
      ll.AddFirst(TObjC.create);
      bo := ll.items[1];
    ...
    50: begin
      VariationName := 'Instead REmove ObjC';
      ll.Add(TObjA.create);
      ll.Add(TObjB.create);
      ll.AddFirst(TObjC.create);
      //-----------------------
    ...
    60: begin
      VariationName := 'Instead REmove ObjB';
      ll.Add(TObjA.create);
      ll.Add(TObjB.create);
      ll.AddFirst(TObjC.create);
      //-----------------------
    ...
    70: begin
      VariationName := 'Instead Replace ObjC with ObjD';
      ll.Add(TObjA.create);
      ll.Add(TObjB.create);
      ll.AddFirst(TObjC.create);
      //-----------------------
      ll.Replace(ll.Items[0], TObjD.create);
      utresult := DebugContents;
    end;
    80: begin
      VariationName := 'Instead Replace ObjB with ObjD';
      ll.Add(TObjA.create);
      ll.Add(TObjB.create);
      ll.AddFirst(TObjC.create);
      //-----------------------
      ll.Replace(ll.Items[2], TObjD.create);
      utresult := DebugContents;
    end;
    90: begin
      VariationName := 'Instead Replace ObjA with ObjD';
      ll.Add(TObjA.create);
      ll.Add(TObjB.create);
      ll.AddFirst(TObjC.create);
      //-----------------------
      ll.Replace(ll.Items[1], TObjD.create);
      utresult := DebugContents;
    end;
    100: begin
      VariationName := 'Start exactly two objects, but remove first';
      ll.Add(TObjA.create);
      ll.Add(TObjB.create);
      //-----------------------
      ll.Delete(0);
    ...
    110: begin
      VariationName := 'Start exactly two objects, but remove second';
      ll.Add(TObjA.create);
      ll.Add(TObjB.create);
      //-----------------------
      ll.Delete(1);
    ...
    120: begin
      VariationName := 'Add List of 1 (B) objects to (A)';
      ll.Add(TObjA.create);
      ll2.Add(TObjB.create);
      ll.AddList(ll2);
      utresult := DebugContents;
    end;
    130: begin
      VariationName := 'Add List of 2 objects (B,C) to (A)';
      ll.Add(TObjA.create);
      ll2.Add(TObjB.create);
      ll2.Add(TObjC.create);
      ll.AddList(ll2);
      utresult := DebugContents;
    end;
    140: begin
      VariationName := 'Add List of 2 objects (C,D) to (A,B)';
      ll.Add(TObjA.create);
      ll.Add(TObjB.create);
      ll2.Add(TObjC.create);
      ll2.Add(TObjD.create);
      ll.AddList(ll2);
      utresult := DebugContents;
    end;
    150: begin
      VariationName := 'Add List of 2 objects (C,D) to ()';
      ll2.Add(TObjC.create);
      ll2.Add(TObjD.create);
      ll.AddList(ll2);
      utresult := DebugContents;
    ...
    160: begin
      VariationName := 'Add List of 0 objects to (A,B)';
      ll.Add(TObjA.create);
      ll.Add(TObjB.create);
      ll.AddList(ll2);
      utresult := DebugContents;
    ...
    170: begin
      VariationName := 'Add List of 1 objects (B) to (A)';
      ll.Add(TObjA.create);
      ll2.Add(TObjB.create);
      ll.AddList(ll2);
      utresult := DebugContents;
    ...
    180: begin
      VariationName := 'Add List of 1 objects (B) to (A) then clear';
      ll.Add(TObjA.create);
      ll2.Add(TObjB.create);
      ll.AddList(ll2);
      ll.clear;
    ...
    1: begin
      VariationName := 'Add the same object twice in error';
      tmp := TobjA.create;
      ll.Add(tmp);
      ll.Add(tmp);
      ll.clear;
...
procedure TUT_LinkedList.FreeAllObjects;
var
  bo: TBetterObject;
begin
  while ll.first <> nil do begin
    bo := ll.first;
    ll.remove(bo);
    bo.free;
    bo := nil;
  end;
  while ll2.first <> nil do begin
    bo := ll2.first;
    ll2.remove(bo);
    bo.free;
    bo := nil;
...
procedure TUT_LinkedList.Init;
begin
  inherited;
  ll := TDirectlyLInkedList_Shared<TBetterObject>.create;
  ll2 := TDirectlyLInkedList_Shared<TBetterObject>.create;

end;

{ TUT_LinkedList.TDebuggable }

function TUT_LinkedList.TDebuggable.GetDebug: string;
var
  sPrev: string;
  sNExt: string;
begin
  ...
  sNExt := '';
  if prev <> nil then
    sPrev := TDebuggable(prev).Classname+'<--';
  if next <> nil then
    sNExt := '-->'+TDebuggable(next).Classname;


  result := sPRev+ClassName+sNext;
end;
...
initialization
  ...
  UTF.RegisterClass(TUT_LinkedList);
