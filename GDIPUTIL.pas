...
function ValueTypeFromULONG(Type_: ULONG): ansistring;
function GetMetaDataIDString(id: ULONG): ansistring;
function GetEncoderClsid(format: ansistring; out pClsid: TGUID): integer;
function GetStatus(Stat: TStatus): ansistring;
function PixelFormatString(PixelFormat: TPixelFormat): ansistring;
