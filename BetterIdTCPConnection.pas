...
type
  ...
  protected
    ...
    procedure SetIOHandler(AValue: BetterIdIOHandler.TIdIOHandler); virtual;
...
procedure TIdTCPConnection.SetIOHandler(AValue: BetterIdIOHandler.TIdIOHandler);
var
  // under ARC, convert weak references to strong references before working with them
  LIOHandler: TIdIOHandler;
...
begin
  ...
  if LIOHandler <> AValue then begin
    ...
    if Assigned(AValue) then begin
      ...
      if AValue is BetterIdIOHandlerSocket.TIdIOHandlerSocket then begin
        FSocket := BetterIdIOHandlerSocket.TIdIOHandlerSocket(AValue);
      end;
    end;
