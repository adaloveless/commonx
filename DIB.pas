...
{$IFDEF CPUX64}{$DEFINE PP}{$ENDIF}
{$IFNDEF CPUX64}{$IFNDEF CPUX86}{$DEFINE INLINEASM}{$ENDIF}{$ENDIF}
uses
...
type
  ...
  private
    ...
    procedure NegativeASM(Size: NativeInt; P: Pointer);
  protected
  ...
  public
    ...
    procedure SetSize(AWidth, AHeight, ABitCount: Integer);reintroduce;virtual;
    ...
    begin
      ...
      for y := 0 to height-1 do begin
        for x := 0 to width -1 do begin
          self.pixels[x,y] := (self.pixels[x,y] and dword(clWhite)) or (dword(random(255)) shl 24);
        end;
      end;
    end;
  end;
...
procedure TDIB.NegativeASM(Size: NativeInt; P:Pointer);assembler;
{$IFDEF CPUX64}
asm
  mov rdx,rcx
  mov rax,rbx
