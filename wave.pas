...
type
  ...
  public
    constructor Create(const FileName: ansistring; FileMode: Integer);
    destructor Destroy; override;
  end;
...
procedure TWave.LoadFromFile(const FileName : ansistring);
var
  Stream: TFileStream;
begin
...
procedure TWave.SaveToFile(const FileName : ansistring);
var
  Stream: TFileStream;
begin
...
constructor TWaveFileStream.Create(const FileName: ansistring; FileMode: Integer);
begin
