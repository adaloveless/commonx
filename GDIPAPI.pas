...
{$ENDIF}
//---------------------------------------------------------------------------
// ansistringFormatFlags
//---------------------------------------------------------------------------

//---------------------------------------------------------------------------
// ansistring format flags
//
...
//                                  each line, AnsiCharacters progress from top to
//                                  bottom.
...
//                                  will ensure the AnsiCharacter aligns visually
//                                  with the lines above and below, but may
//                                  cause some pixels outside the formatting
//                                  rectangle to be clipped or painted.
//
//  DisplayFormatControl          - Causes control AnsiCharacters such as the
//                                  left-to-right mark to be shown in the
//                                  output with a representative glyph.
//
//  NoFontFallback                - Disables fallback to alternate fonts for
//                                  AnsiCharacters not supported in the requested
//                                  font. Any missing AnsiCharacters will be
...
//---------------------------------------------------------------------------
  ...
  {$EXTERNALSYM ansistringFormatFlags}
  ansistringFormatFlags = Integer;
  const
    ansistringFormatFlagsDirectionRightToLeft        = $00000001;
    ansistringFormatFlagsDirectionVertical           = $00000002;
    ansistringFormatFlagsNoFitBlackBox               = $00000004;
    ansistringFormatFlagsDisplayFormatControl        = $00000020;
    ansistringFormatFlagsNoFontFallback              = $00000400;
    ansistringFormatFlagsMeasureTrailingSpaces       = $00000800;
    ansistringFormatFlagsNoWrap                      = $00001000;
    ansistringFormatFlagsLineLimit                   = $00002000;

    ansistringFormatFlagsNoClip                      = $00004000;

Type
  TStringFormatFlags = ansistringFormatFlags;

//---------------------------------------------------------------------------
// ansistringTrimming
//---------------------------------------------------------------------------

  {$EXTERNALSYM ansistringTrimming}
  ansistringTrimming = (
    ansistringTrimmingNone,
    ansistringTrimmingCharacter,
    ansistringTrimmingWord,
    ansistringTrimmingEllipsisCharacter,
    ansistringTrimmingEllipsisWord,
    ansistringTrimmingEllipsisPath
  );
  TStringTrimming = ansistringTrimming;

//---------------------------------------------------------------------------
// National language digit substitution
//---------------------------------------------------------------------------

  {$EXTERNALSYM ansistringDigitSubstitute}
  ansistringDigitSubstitute = (
    ansistringDigitSubstituteUser,          // As NLS setting
    ansistringDigitSubstituteNone,
    ansistringDigitSubstituteNational,
    ansistringDigitSubstituteTraditional
  );
  TStringDigitSubstitute = ansistringDigitSubstitute;
...
//---------------------------------------------------------------------------
// ansistring alignment flags
//---------------------------------------------------------------------------

  {$EXTERNALSYM ansistringAlignment}
  ansistringAlignment = (
    // Left edge for left-to-right text,
    // right for right-to-left text,
    // and top for vertical
    ansistringAlignmentNear,
    ansistringAlignmentCenter,
    ansistringAlignmentFar
  );
  TStringAlignment = ansistringAlignment;
...
type
  ...
  PAnsiCharacterRange = ^TCharacterRange;
...
type
  ...
  ENHMETAHEADER3 = packed record
    ...
    nDescription   : DWORD;  // Number of AnsiChars in the unicode desc ansistring
                             // This is 0 if there is no description ansistring
...
\**************************************************************************)
  ...
  function GdipAddPathString(path: GPPATH; ansistring_: PWCHAR; length: Integer;
  ...
  function GdipAddPathStringI(path: GPPATH; ansistring_: PWCHAR; length: Integer;
...
//----------------------------------------------------------------------------
  ...
  function GdipDrawString(graphics: GPGRAPHICS; ansistring_: PWCHAR;
    length: Integer; font: GPFONT; layoutRect: PGPRectF;
    ansistringFormat: GPSTRINGFORMAT; brush: GPBRUSH): GPSTATUS; stdcall;
  {$EXTERNALSYM GdipDrawString}

  function GdipMeasureString(graphics: GPGRAPHICS; ansistring_: PWCHAR;
    length: Integer; font: GPFONT; layoutRect: PGPRectF;
    ansistringFormat: GPSTRINGFORMAT; boundingBox: PGPRectF;
    codepointsFitted: PInteger; linesFilled: PInteger): GPSTATUS; stdcall;
  {$EXTERNALSYM GdipMeasureString}

  function GdipMeasureCharacterRanges(graphics: GPGRAPHICS; ansistring_: PWCHAR;
    length: Integer; font: GPFONT; layoutRect: PGPRectF;
    ansistringFormat: GPSTRINGFORMAT; regionCount: Integer;
...
//----------------------------------------------------------------------------
  ...
  function GdipSetStringFormatDigitSubstitution(format: GPSTRINGFORMAT;
    language: LANGID;
    substitute: ansistringDIGITSUBSTITUTE): GPSTATUS; stdcall;
  ...
  function GdipSetStringFormatMeasurableCharacterRanges(format: GPSTRINGFORMAT;
    rangeCount: Integer; ranges: PAnsiCharACTERRANGE): GPSTATUS; stdcall;
