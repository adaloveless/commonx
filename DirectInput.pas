...
const
  ...
  // ansistring constants for Interface IDs
...
(*--- Fighting - First Person Shooting
  ...
  DIAXIS_FPS_ROTATE                       = $09008201; (* Rotate AnsiCharacter left/right *)
...
(*--- Fighting - Third Person action
      Perspective of camera is behind the main AnsiCharacter  ---*)
  ...
  DIBUTTON_TPS_JUMP                       = $0A000405; (* AnsiCharacter Jumps *)
...
(*--- Priority 2 controls                            ---*)
  ...
  DIBUTTON_TPS_STEPLEFT                   = $0A004407; (* AnsiCharacter takes a left step *)
  DIBUTTON_TPS_STEPRIGHT                  = $0A004408; (* AnsiCharacter takes a right step *)
  DIAXIS_TPS_STEP                         = $0A00C203; (* AnsiCharacter steps left/right *)
  DIBUTTON_TPS_DODGE                      = $0A004409; (* AnsiCharacter dodges or ducks *)
...
(*--- Priority 2 controls                            ---*)
  ...
  DIAXIS_FISHING_ROTATE                   = $0E024203; (* Turn AnsiCharacter left / right *)
...
(*--- Priority 2 controls                            ---*)
  ...
  DIBUTTON_SOCCERD_GOALIECHARGE           = $1F00440B; (* Make the goalie AnsiCharge out of the box *)
...
(*--- Arcade - Platform Game
      AnsiCharacter moves around on screen  ---*)
