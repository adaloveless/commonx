...
// context.
procedure THashAlgSHA1Engine.SHA1Update(var context: SHA1_CTX; var input: array of byte; inputLen: cardinal);
var
...
procedure THashAlgSHA1Engine.SHA1Final(var digest: THashArray; var context: SHA1_CTX);
var
...
procedure THashAlgSHA1Engine.SHA1_memcpy(var output: array of byte; var input: array of byte; startA, startB, len: cardinal);
var
  i: cardinal;
begin
  for i:=1 to len do
...
procedure THashAlgSHA1Engine.SHA1_memset(var output: array of byte; value: cardinal; start, len: cardinal);
var
  i: cardinal;
begin
  for i:=1 to len do
