unit SimpleWinsock32;
{$IFNDEF VER150}{$INLINE AUTO}{$ENDIF}
interface
//TODO: Flush buffer on close
//TODO: Flush Buffer on read

uses scktComp, Forms, DtNetConst, Classes, sysutils, SimpleAbstractConnection, windows, shareddebuglog, crossplatformtypes;
,orderlyinit
type
...
initialization
  init.RegisterProcs('SimpleWinsock32', oinit, ofinal);
