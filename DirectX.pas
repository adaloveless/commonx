...
{ TDDDeviceIdentifier structure }
  ...
  TDDDeviceIdentifier = record
    ...
    // drivers, since this is unreliable and many different ansistrings may be associated with the same
 ...
 *)
  ...
  TDPChat = record
    ...
    case Integer of
      0: (
        lpszMessage: LPWSTR;  // Message ansistring - Unicode
        );
      1: (
        lpszMessageA: LPSTR;  // Message ansistring - ANSI
        );
  end;
...
type
  FOURCC = DWORD;         // a four AnsiCharacter code 
