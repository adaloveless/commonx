...
type
  ...
  TDDEnumCallback = function (lpGUID: PGUID; lpDriverDescription: PAnsiChar;
      lpDriverName: PAnsiChar; lpContext: Pointer): BOOL; stdcall;
  ...
  TDDEnumCallbackEx = function (lpGUID: PGUID; lpDriverDescription: PAnsiChar;
      lpDriverName: PAnsiChar; lpContext: Pointer; Monitor: HMonitor): BOOL;
      stdcall;
...
function DDErrorString(Value: HResult): ansistring;
