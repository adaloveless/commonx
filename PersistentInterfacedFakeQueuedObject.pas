unit PersistentInterfacedFakeQueuedObject;
//This unit contains the TPersistentInterfacedObject class.

interface

uses
  ComObj, CommonInterfaces, Windows, fakeLockQueue;

{$D+}

type
//------------------------------------------------------------------------------
  TPersistentInterfacedFakeQueuedObject = class(TFakeLockQueue, IUnknownEnhanced)
...
//------------------------------------------------------------------------------
constructor TPersistentInterfacedFakeQueuedObject.Create;
begin
  inherited;
...
//------------------------------------------------------------------------------
procedure TPersistentInterfacedFakeQueuedObject.Free;
begin
  inherited;
end;
//------------------------------------------------------------------------------
destructor TPersistentInterfacedFakeQueuedObject.Destroy;
begin
...
//------------------------------------------------------------------------------
procedure TPersistentInterfacedFakeQueuedObject.BeforeDestruction;
var
  iREf: integer;
begin
...
//------------------------------------------------------------------------------
function TPersistentInterfacedFakeQueuedObject.QueryInterface(const IID: TGUID; out Obj): HResult; stdcall;
...
procedure TPersistentInterfacedFakeQueuedObject.ReleaseInternalRef;
begin
  bInternalRef := false;
end;

function TPersistentInterfacedFakeQueuedObject._AddRef: Integer;
begin
  result := interlockedincrement(FCOMReferences);

end;

function TPersistentInterfacedFakeQueuedObject._Release: Integer;
begin
...
procedure TPersistentInterfacedFakeQueuedObject.FreeAtWill;
...
procedure TPersistentInterfacedFakeQueuedObject.FreeWithReferences;
