 ...
 *
 * Returned ansistring has been truncated to fit the buffer size.
 *)
...
(* every DMUS_PMSG is based off of this structure. The Performance needs
  ...
  _DMUS_LYRIC_PMSG = record
    ...
    wszString: array[0..0] of WideChar;      (* null-terminated Unicode lyric ansistring (structure is actually larger than size 1) *)
  end;
...
(
    ...
    'coba'
    (
        // Alias, stored as NULL terminated ansistring of WCHARs
    )
...
(
    ...
    name
    (
        // Name, stored as NULL terminated ansistring of WCHARs
    )

    // <file-ck>
    file
    (
        // File name, stored as NULL terminated ansistring of WCHARs
    )

    // <catg-ck>
    catg
    (
        // Category name, stored as NULL terminated ansistring of WCHARs
    )
...
<chrd-list> ::= LIST('chrd' 
                                <INAM-ck>   // name of chord in wide AnsiChar format
...
(
    ...
    'scla'
    (
        // Language name, stored as NULL terminated ansistring of WCHARs
    )

    'scsr'
    (
        // Source code, stored as NULL terminated ansistring of WCHARs
    )
*)
