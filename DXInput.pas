...
type
  ...
  public
    ...
    procedure Clear;
    function Find(const Name: ansistring): TForceFeedbackEffect;
...
function TForceFeedbackEffect.Find(const Name: ansistring): TForceFeedbackEffect;
var
  i, p: Integer;
...
function TForceFeedbackEffect.IndexOf(const Name: ansistring): Integer;
var
  i: Integer;
begin
  Result := -1;
...
procedure TForceFeedbackEffect.LoadFromFile(const FileName: ansistring);
var
  Stream: TFileStream;
begin
...
procedure TForceFeedbackEffect.SaveToFile(const FileName: ansistring);
var
  Stream: TFileStream;
begin
