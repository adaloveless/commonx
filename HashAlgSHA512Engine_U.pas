...
type
  THashAlgSHA512Engine = class
  private
    procedure SHA512Transform(var state: array of LONGLONG; block: array of byte; startOffsetInBlock: cardinal);
    ...
    procedure SHA512_memcpy(var output: array of byte; var input: array of byte; startA, startB, len: cardinal);
    procedure SHA512_memset(var output: array of byte; value: cardinal; start, len: cardinal);
  ...
  public
    ...
    procedure SHA512Update(var context: SHA512_CTX; var input: array of byte; inputLen: cardinal);
    procedure SHA512Final(var digest: THashArray; var context: SHA512_CTX);
  end;
...
// context.
procedure THashAlgSHA512Engine.SHA512Update(var context: SHA512_CTX; var input: array of byte; inputLen: cardinal);
var
...
begin
  ...
  if (inputLen >= partLen) then
    begin
    SHA512_memcpy(context.buffer, input, index, 0, partLen);
  ...
  SHA512_memcpy(context.buffer, input, index, i, inputLen-i);

end;

// SHA512 finalization. Ends an SHA512 message-digest operation, writing the
// the message digest and zeroizing the context.
procedure THashAlgSHA512Engine.SHA512Final(var digest: THashArray; var context: SHA512_CTX);
var
...
begin
  ...
  SHA512_memset(context.buffer, 0, 0, high(context.buffer)+1);

end;


// SHA512 basic transformation. Transforms state based on block.
procedure THashAlgSHA512Engine.SHA512Transform(var state: array of LONGLONG; block: array of byte; startOffsetInBlock: cardinal);
var
...
// a multiple of 8.
procedure THashAlgSHA512Engine.Encode(var output: array of byte; var input: array of LONGLONG; len: cardinal);
var
  i, j: cardinal;
begin
  i := 0;
...
// a multiple of 8.
procedure THashAlgSHA512Engine.Decode(var output: array of LONGLONG; var input: array of byte; len: cardinal);
var
  i, j: cardinal;
  low32Bits: LONGLONG;
  high32Bits: LONGLONG;
...
procedure THashAlgSHA512Engine.SHA512_memcpy(var output: array of byte; var input: array of byte; startA, startB, len: cardinal);
var
  i: cardinal;
begin
  for i:=1 to len do
...
procedure THashAlgSHA512Engine.SHA512_memset(var output: array of byte; value: cardinal; start, len: cardinal);
var
  i: cardinal;
begin
  for i:=1 to len do
...
function THashAlgSHA512Engine.Ch(x, y, z: LONGLONG): LONGLONG;
begin
  Result := (x AND y) xor (not(x) AND z);
end;


function THashAlgSHA512Engine.Maj(x, y, z: LONGLONG): LONGLONG;
begin
  Result := (x AND y) xor (x AND z) xor (y AND z);
end;


function THashAlgSHA512Engine.sigmaE0(x: LONGLONG): LONGLONG;
begin
  Result := ROTR(x, 28) xor ROTR(x, 34) xor ROTR(x, 39);
end;


function THashAlgSHA512Engine.sigmaE1(x: LONGLONG): LONGLONG;
begin
  Result := ROTR(x, 14) xor ROTR(x, 18) xor ROTR(x, 41);
end;


function THashAlgSHA512Engine.sigmao0(x: LONGLONG): LONGLONG;
begin
  Result := ROTR(x, 1) xor ROTR(x, 8) xor (x shr 7);
end;


function THashAlgSHA512Engine.sigmao1(x: LONGLONG): LONGLONG;
begin
...
// onto the other end
function THashAlgSHA512Engine.ROTR(x: LONGLONG; n: cardinal): LONGLONG;
begin
