...
procedure FFT_bitreverse(_N: Integer; data: PDoubleArray);
procedure FFT_transform(_N: Integer; data: PDoubleArray);
procedure FFT_inverse(_N: Integer; data: PDoubleArray);
