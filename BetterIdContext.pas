...
uses
  Classes,
  BetterIdSocketHandle, BetterIdTCPConnection, IdTask, IdYarn, IdThreadSafe,
...
type
  ...
  protected
    ...
    FConnection: betteridtcpconnection.TIdTCPConnection;
  ...
  public
    constructor Create(
      AConnection: BetterIdTCPConnection.TIdTCPConnection;
      AYarn: TIdYarn;
    ...
    property Connection: BetterIdTCPConnection.TIdTCPConnection read FConnection;
    //
...
uses
  ...
  {$ENDIF}
  IdGlobal,
  BetterIdIOHandlerSocket;

constructor TIdContext.Create(AConnection: BetterIdTCPConnection.TIdTCPConnection; AYarn: TIdYarn;
  AList: TIdContextThreadList = nil);
begin
...
var
  ...
  LConn: BetterIdTCPConnection.TIdTCPConnection;
  LSocket: BetterIdIOHandlerSocket.TIdIOHandlerSocket;
begin
  Result := nil;
  LConn := Connection;
