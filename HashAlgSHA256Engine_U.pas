...
type
  ...
  private
    ...
    procedure SHA256_memcpy(var output: array of byte; var input: array of byte; startA, startB, len: cardinal);
    procedure SHA256_memset(var output: array of byte; value: cardinal; start, len: cardinal);
  ...
  public
    ...
    procedure SHA256Update(var context: SHA256_CTX; var input: array of byte; inputLen: cardinal);
    procedure SHA256Final(var digest: THashArray; var context: SHA256_CTX);
  end;
...
// context.
procedure THashAlgSHA256Engine.SHA256Update(var context: SHA256_CTX; var input: array of byte; inputLen: cardinal);
var
...
begin
  ...
  if (inputLen >= partLen) then
    begin
    SHA256_memcpy(context.buffer, input, index, 0, partLen);
  ...
  SHA256_memcpy(context.buffer, input, index, i, inputLen-i);

end;

// SHA256 finalization. Ends an SHA256 message-digest operation, writing the
// the message digest and zeroizing the context.
procedure THashAlgSHA256Engine.SHA256Final(var digest: THashArray; var context: SHA256_CTX);
var
...
begin
  ...
  SHA256_memset(context.buffer, 0, 0, high(context.buffer)+1);
...
procedure THashAlgSHA256Engine.SHA256_memcpy(var output: array of byte; var input: array of byte; startA, startB, len: cardinal);
var
  i: cardinal;
begin
  for i:=1 to len do
...
procedure THashAlgSHA256Engine.SHA256_memset(var output: array of byte; value: cardinal; start, len: cardinal);
var
  i: cardinal;
begin
  for i:=1 to len do
